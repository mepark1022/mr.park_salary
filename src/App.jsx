            ...
            <div style={{ padding: 16 }}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 6 }}>
                  ...
                  <input type="number" value={wdBreak} min={0} step={30} onChange={e => setWdBreak(parseInt(e.target.value) || 0)} style={{ ...inputStyle, width: 72, textAlign: "center" }} />
                ...
                {weDays > 0 && (
                  <>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 6 }}>
                      ...
                      <input type="number" value={weBreak} min={0} step={30} onChange={e => setWeBreak(parseInt(e.target.value) || 0)} style={{ ...inputStyle, width: 72, textAlign: "center" }} />
                      <span style={{ fontSize: 11, color: C.gray, whiteSpace: "nowrap" }}>분 휴게</span>
                    </div>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: 16, fontSize: 12 }}>
                ...
                <tbody>
                  {[
                    ...
                    ...(weDays > 0 ? [{ no: 2, name: `인건비 (주말 / 주${weDays}일)`, amount: weekend.perPerson, qty: weHead, sub: laborWeekend, detail: "" }] : []),
